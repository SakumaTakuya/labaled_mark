...
export const LZMA = (function () {
  ...
  function $GetMatches(this$static, distances) {
    ...
    if (this$static.HASH_ARRAY) {
      temp =
        CrcTable[this$static._bufferBase[cur] & 255] ^ (this$static._bufferBase[cur + 1] & 255);
      hash2Value = temp & 1023;
      temp ^= (this$static._bufferBase[cur + 2] & 255) << 8;
      hash3Value = temp & 65535;
      hashValue =
        (temp ^ (CrcTable[this$static._bufferBase[cur + 3] & 255] << 5)) & this$static._hashMask;
    } else {
      hashValue =
        (this$static._bufferBase[cur] & 255) ^ ((this$static._bufferBase[cur + 1] & 255) << 8);
    }
  ...
  function $CodeOneChunk(this$static) {
    ...
    if (
      ...
      if ($DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepDecoders, this$static.state)) {
        len = 0;
        if (
          !$DecodeBit(this$static.m_RangeDecoder, this$static.m_IsRepG0Decoders, this$static.state)
        ) {
          if (
            !$DecodeBit(
              this$static.m_RangeDecoder,
        ...
        if (posSlot >= 4) {
          ...
          if (posSlot < 14) {
            ...
            this$static.rep0 +=
              $DecodeDirectBits(this$static.m_RangeDecoder, numDirectBits - 4) << 4;
            this$static.rep0 += $ReverseDecode(
    ...
    for (lenToPosState = 0; lenToPosState < 4; ++lenToPosState) {
      ...
      for (; i < 128; ++i) {
        this$static._distancesPrices[st2 + i] =
          this$static._posSlotPrices[st + GetPosSlot(i)] + this$static.tempPrices[i];
      }
    }
  ...
  function $GetOptimum(this$static, position) {
    ...
    matchPrice =
      ProbPrices[(2048 - this$static._isMatch[(this$static._state << 4) + posState]) >>> 2];
    ...
    lenEnd =
      lenMain >= this$static.repLens[repMaxIndex] ? lenMain : this$static.repLens[repMaxIndex];
    if (lenEnd < 2) {
    ...
    while (1) {
      ...
      matchPrice =
        curPrice + ProbPrices[(2048 - this$static._isMatch[(state << 4) + posState]) >>> 2];
        ...
        if (lenTest < numAvailableBytesFull) {
          ...
          if (lenTest2 >= 2) {
            ...
            nextMatchPrice =
              ...
              ProbPrices[(2048 - this$static._isMatch[(state2 << 4) + posStateNext]) >>> 2];
            nextRepMatchPrice =
              nextMatchPrice + ProbPrices[(2048 - this$static._isRep[state2]) >>> 2];
      ...
      if (newLen >= startLen) {
        ...
        for (lenTest = startLen; ; ++lenTest) {
          ...
          curAndLenPrice =
            normalMatchPrice + $GetPosLenPrice(this$static, curBack, lenTest, posState);
          optimum = this$static._optimum[cur + lenTest];
          if (curAndLenPrice < optimum.Price) {
            optimum.Price = curAndLenPrice;
            optimum.PosPrev = cur;
  ...
  function $WriteCoderProperties(this$static, outStream) {
    this$static.properties[0] =
      (((this$static._posStateBits * 5 + this$static._numLiteralPosStateBits) * 9 +
        this$static._numLiteralContextBits) <<
        24) >>
      24;
    for (var i = 0; i < 4; ++i) {
  ...
  function compress(str, mode, on_finish, on_progress) {
    ...
    function do_action() {
      try {
        ...
        while ($processChunk(this$static.c.chunker)) {
          percent =
            toDouble(this$static.c.chunker.inBytesProcessed) / toDouble(this$static.c.length_0);
